$(document).ready(function () {
    ...
    var n = 100, t = !0, s = !1, i = !1, l = !1, a = $("body"),
        o = ($(".page-header"), $(".page-sidebar"), $(".page-content"), function () {
            ...
            e.hide(), t === !1 && $(".sub-menu li").each(function (e) {
                ...
                var e = $(this).next(".sub-menu"), s = $(this).parent("li"), i = $(".accordion-menu > li.open"),
                    l = function () {
            ...
            var e = function () {
                $(".chat-write form input").on("keypress", function (e) {
                    ...
                    $(".right-sidebar-chat").slimscroll({allowPageScroll: !0, scrollTo: n})
                })
            };
            e()
        }, b = function () {
